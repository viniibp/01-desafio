"use strict";var Xt=require("node:url"),re=require("esbuild"),jt=require("node:crypto"),x=require("node:fs"),P=require("node:path"),Pt=require("node:os"),Tt=require("./temporary-directory-B83uKxJF.cjs");const Je=i=>jt.createHash("sha1").update(i).digest("hex"),Re=44,Wt=59,ve="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",xe=new Uint8Array(64),Ue=new Uint8Array(128);for(let i=0;i<ve.length;i++){const e=ve.charCodeAt(i);xe[i]=e,Ue[e]=i}const we=typeof TextDecoder<"u"?new TextDecoder:typeof Buffer<"u"?{decode(i){return Buffer.from(i.buffer,i.byteOffset,i.byteLength).toString()}}:{decode(i){let e="";for(let A=0;A<i.length;A++)e+=String.fromCharCode(i[A]);return e}};function $t(i){const e=new Int32Array(5),A=[];let n=0;do{const o=Zt(i,n),a=[];let c=!0,C=0;e[0]=0;for(let f=n;f<o;f++){let Q;f=T(i,f,e,0);const u=e[0];u<C&&(c=!1),C=u,Fe(i,f,o)?(f=T(i,f,e,1),f=T(i,f,e,2),f=T(i,f,e,3),Fe(i,f,o)?(f=T(i,f,e,4),Q=[u,e[1],e[2],e[3],e[4]]):Q=[u,e[1],e[2],e[3]]):Q=[u],a.push(Q)}c||Vt(a),A.push(a),n=o+1}while(n<=i.length);return A}function Zt(i,e){const A=i.indexOf(";",e);return A===-1?i.length:A}function T(i,e,A,n){let o=0,a=0,c=0;do{const f=i.charCodeAt(e++);c=Ue[f],o|=(c&31)<<a,a+=5}while(c&32);const C=o&1;return o>>>=1,C&&(o=-2147483648|-o),A[n]+=o,e}function Fe(i,e,A){return e>=A?!1:i.charCodeAt(e)!==Re}function Vt(i){i.sort(zt)}function zt(i,e){return i[0]-e[0]}function Ge(i){const e=new Int32Array(5),A=1024*16,n=A-36,o=new Uint8Array(A),a=o.subarray(0,n);let c=0,C="";for(let f=0;f<i.length;f++){const Q=i[f];if(f>0&&(c===A&&(C+=we.decode(o),c=0),o[c++]=Wt),Q.length!==0){e[0]=0;for(let u=0;u<Q.length;u++){const r=Q[u];c>n&&(C+=we.decode(a),o.copyWithin(0,n,c),c-=n),u>0&&(o[c++]=Re),c=W(o,c,e,r,0),r.length!==1&&(c=W(o,c,e,r,1),c=W(o,c,e,r,2),c=W(o,c,e,r,3),r.length!==4&&(c=W(o,c,e,r,4)))}}}return C+we.decode(o.subarray(0,c))}function W(i,e,A,n,o){const a=n[o];let c=a-A[o];A[o]=a,c=c<0?-c<<1|1:c<<1;do{let C=c&31;c>>>=5,c>0&&(C|=32),i[e++]=xe[C]}while(c>0);return e}class ae{constructor(e){this.bits=e instanceof ae?e.bits.slice():[]}add(e){this.bits[e>>5]|=1<<(e&31)}has(e){return!!(this.bits[e>>5]&1<<(e&31))}}class z{constructor(e,A,n){this.start=e,this.end=A,this.original=n,this.intro="",this.outro="",this.content=n,this.storeName=!1,this.edited=!1,this.previous=null,this.next=null}appendLeft(e){this.outro+=e}appendRight(e){this.intro=this.intro+e}clone(){const e=new z(this.start,this.end,this.original);return e.intro=this.intro,e.outro=this.outro,e.content=this.content,e.storeName=this.storeName,e.edited=this.edited,e}contains(e){return this.start<e&&e<this.end}eachNext(e){let A=this;for(;A;)e(A),A=A.next}eachPrevious(e){let A=this;for(;A;)e(A),A=A.previous}edit(e,A,n){return this.content=e,n||(this.intro="",this.outro=""),this.storeName=A,this.edited=!0,this}prependLeft(e){this.outro=e+this.outro}prependRight(e){this.intro=e+this.intro}reset(){this.intro="",this.outro="",this.edited&&(this.content=this.original,this.storeName=!1,this.edited=!1)}split(e){const A=e-this.start,n=this.original.slice(0,A),o=this.original.slice(A);this.original=n;const a=new z(e,this.end,o);return a.outro=this.outro,this.outro="",this.end=e,this.edited?(a.edit("",!1),this.content=""):this.content=n,a.next=this.next,a.next&&(a.next.previous=a),a.previous=this,this.next=a,a}toString(){return this.intro+this.content+this.outro}trimEnd(e){if(this.outro=this.outro.replace(e,""),this.outro.length)return!0;const A=this.content.replace(e,"");if(A.length)return A!==this.content&&(this.split(this.start+A.length).edit("",void 0,!0),this.edited&&this.edit(A,this.storeName,!0)),!0;if(this.edit("",void 0,!0),this.intro=this.intro.replace(e,""),this.intro.length)return!0}trimStart(e){if(this.intro=this.intro.replace(e,""),this.intro.length)return!0;const A=this.content.replace(e,"");if(A.length){if(A!==this.content){const n=this.split(this.end-A.length);this.edited&&n.edit(A,this.storeName,!0),this.edit("",void 0,!0)}return!0}else if(this.edit("",void 0,!0),this.outro=this.outro.replace(e,""),this.outro.length)return!0}}function eA(){return typeof globalThis<"u"&&typeof globalThis.btoa=="function"?i=>globalThis.btoa(unescape(encodeURIComponent(i))):typeof Buffer=="function"?i=>Buffer.from(i,"utf-8").toString("base64"):()=>{throw new Error("Unsupported environment: `window.btoa` or `Buffer` should be supported.")}}const tA=eA();let AA=class{constructor(e){this.version=3,this.file=e.file,this.sources=e.sources,this.sourcesContent=e.sourcesContent,this.names=e.names,this.mappings=Ge(e.mappings),typeof e.x_google_ignoreList<"u"&&(this.x_google_ignoreList=e.x_google_ignoreList)}toString(){return JSON.stringify(this)}toUrl(){return"data:application/json;charset=utf-8;base64,"+tA(this.toString())}};function rA(i){const e=i.split(`
`),A=e.filter(a=>/^\t+/.test(a)),n=e.filter(a=>/^ {2,}/.test(a));if(A.length===0&&n.length===0)return null;if(A.length>=n.length)return"	";const o=n.reduce((a,c)=>{const C=/^ +/.exec(c)[0].length;return Math.min(C,a)},1/0);return new Array(o+1).join(" ")}function nA(i,e){const A=i.split(/[/\\]/),n=e.split(/[/\\]/);for(A.pop();A[0]===n[0];)A.shift(),n.shift();if(A.length){let o=A.length;for(;o--;)A[o]=".."}return A.concat(n).join("/")}const iA=Object.prototype.toString;function sA(i){return iA.call(i)==="[object Object]"}function Me(i){const e=i.split(`
...
`,c+1)}const f=[this.generatedCodeColumn,e,n.line,n.column];o>=0&&f.push(o),this.rawSegments.push(f),this.advance(A.slice(C+1))}else this.pending&&(this.rawSegments.push(this.pending),this.advance(A));this.pending=null}addUneditedChunk(e,A,n,o,a){let c=A.start,C=!0,f=!1;for(;c<A.end;){if(this.hires||C||a.has(c)){const Q=[this.generatedCodeColumn,e,o.line,o.column];this.hires==="boundary"?oA.test(n[c])?f||(this.rawSegments.push(Q),f=!0):(this.rawSegments.push(Q),f=!1):this.rawSegments.push(Q)}n[c]===`
